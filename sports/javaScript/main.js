...
myHttp.open('GET', `
https://newsapi.org/v2/top-headlines?country=eg&category=sports&apiKey=fa466f364d20453b9a45f6df6839953f`)
myHttp.send()
...
function displaySlide(){
    ...
    for(i=0; i< all.length; i++){
        slider+=`
        <p class="m-0 py-5 fw-bold d-inline">
        ${all[i].title}
        </p>
        <div class="sep my-0 mx-4 d-inline">
        </div>
        `
    }
